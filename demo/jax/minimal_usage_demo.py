...
import cr_pulse_interpolator.jax.signal_interpolation_fourier as sigF

from demo_helper import read_data_hdf5, plot_pulse_and_spectrum
...
(zenith, azimuth, xmax, footprint_pos_x, footprint_pos_y, test_pos_x, test_pos_y, footprint_antenna_data, test_antenna_data) = read_data_hdf5(demo_filename)
...
plot_pulse_and_spectrum(orig_pulse[:, pol], jnp.roll(interpolated_pulse[:, pol], sample_offset),
                                    this_x, this_y, -1, pol)
